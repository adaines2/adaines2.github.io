class MyHeader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      ...
      <nav class="navbar navbar-expand-lg navbar-expand-xl navbar-dark bg-dark" aria-label="Eighth navbar example">
        <div class="container">
          <a href="/" class="navbar-brand"> 
              <img src="../assets/brand/mamabird-logo2.svg" width="160px" height="40px">
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="index.html" id="dropdown07" data-bs-toggle="dropdown" aria-expanded="false">Recommended Products</a>
                  <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdown07">
                    <li><a class="dropdown-item" href="#">Autism</a></li>
                    <li><a class="dropdown-item" href="#">Hearing</a></li>
                  </ul>
                </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="resouces.html" id="dropdown07" data-bs-toggle="dropdown" aria-expanded="false">Resources</a>
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdown07">
            ...
            <ul class="nav justify-content-end navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="#"><button class="btn btn-outline-primary" type="button">Sign Up</button></a>
              </li>
            </ul>
          </div>
        </div>
...
class MyFooter extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      ...
      <div class="container">
        <div class="d-flex justify-content-between py-0 my-0 border-top"></div>
        <footer class="py-5">
          <div class="row">
            <div class="col">
              <h5>Patients</h5>
